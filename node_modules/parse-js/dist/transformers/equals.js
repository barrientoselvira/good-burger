...
function EqualsTransformer(match) {
...
EqualsTransformer.prototype.parse = function (value) {
    if (this._match instanceof RegExp) return this._match.test(value);

    if (typeof this._match === 'function') return this._match(value);

    if (this._strict) return this._match === value;

    return this._match == value;
};

EqualsTransformer.prototype.reverse = function (value) {
    if (value) return this._reverse;
