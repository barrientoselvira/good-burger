...
SpecTransformer.prototype._toSpec = function (spec, data) {
    ...
    return _transform(spec, function (r, v, k) {
        if (_isPlainObject(v)) r[k] = _this2._toSpec(v, data);else r[k] = v.parse(data);
    }, {});
};
...
SpecTransformer.prototype._fromSpec = function (spec, data) {
    ...
    return _transform(spec, function (r, v, k) {
        ...
        if (_isPlainObject(v)) _merge(r, _this3._fromSpec(v, value));else _merge(r, v.reverse(value));
    }, {});
};
