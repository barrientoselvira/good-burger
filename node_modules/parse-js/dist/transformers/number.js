...
NumberTransformer.prototype.parse = function (value) {
    ...
    if (!isNumber && this._base !== 10) value = parseInt(value, this._base);else if (!isNumber) value = parseFloat(value);

    if (isNaN(value)) return this._NaNValue;
...
NumberTransformer.prototype.reverse = function (value) {
    ...
    if (isNumber && this._base !== 10) value = value.toString(this._base);
